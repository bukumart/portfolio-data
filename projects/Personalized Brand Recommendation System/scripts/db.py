...
USERNAME_STEROID = os.environ.get("USERNAME_STEROID")
PASSWORD_STEROID = os.environ.get("PASSWORD_STEROID")
HOST_STEROID = os.environ.get("HOST_STEROID")
PORT_STEROID = os.environ.get("PORT_STEROID")
...
class Connections:
    ...
    def steroid(dbName="esb_loop_steroid"):
        return newConnection(
            con="steroid",
            user=USERNAME_STEROID,
            password=PASSWORD_STEROID,
            host=HOST_STEROID,
            port=PORT_STEROID,
            dbName=dbName,
        )